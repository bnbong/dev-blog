...
지난 포스트에서는 깃허브 저장소의 README.md를 활용해 본인의 소개를 프로필에 띄우는 방법을 다뤘습니다.

<https://bnbong.com/blog/20240112-readme-profile/>

그동안 일 때문에 코딩을 못하고 있다가 깃허브 잔디에 자꾸 빈 공간이 생기는 게 마음에 걸려서, 제 깃허브 프로필 소개를 업데이트하고자 제가 작성했던 포스팅을 참고하면서 지난 3일간 프로필을 업데이트했습니다.

다음 깃허브 저장소에 소개된 README를 꾸미는 방법을 꼼꼼히 참고하면서 수정을 거쳤습니다.

<https://github.com/rzashakeri/beautify-github-profile>

정말 많은 분량의 리드미 꾸미는 방법이 소개되어 있는데, 그중 자신이 작성했던 블로그 포스팅을 실시간으로 README에 반영하는 방법이 소개되어 있어서 신기했습니다. 그래서 이걸 적용하는 방법을 이번 포스팅에서 다뤄보려 합니다.
...
이제 본문으로 들어와서, 깃허브 README에 내가 블로그 포스팅으로 작성한 게시물들을 실시간으로 띄울 수 있는 기능은 다음 Repo에 소개되어 있습니다.
...
필자의 블로그를 기준으로 자신의 블로그의 RSS 피드 링크를 확인하는 방법은 다음과 같습니다.

![naverpractice](naverpractice.png)

본인 블로그 메인 페이지나 설정 페이지에서 잘 찾아보면 사진과 같이 RSS 2.0, RSS 1.0 ATOM 0.3이라는 텍스트 링크가 보일 텐데, 저걸 누르면 다음과 같이 XML 소스코드가 나옵니다.
