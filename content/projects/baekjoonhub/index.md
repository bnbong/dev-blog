...
[BaekjoonHub](https://github.com/BaekjoonHub/BaekjoonHub)은 백준, 프로그래머스, SWEA에서 맞은 풀이를 자동으로 GitHub 저장소에 커밋해 주는 브라우저 확장입니다. 제가 SWEA에서 직접 사용하다가 마주친 자동 업로드 중단 버그를 수정해 기여했습니다.
...
- 메인테이너가 공백 정규화와 `.badge` 자식 제거를 적용한 핫픽스를 배포했습니다.
...
기능을 고치는 일만큼이나 "왜 제 테스트에서는 안 잡혔는가"를 되짚는 과정이 기억에 남는 기여였습니다.
