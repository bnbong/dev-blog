...
Azure SDK Python 공식 가이드 문서를 한국어로 번역한 기여 경험입니다. OSSCA 활동 중
Python 구현 가이드의 일부를 한국어로 옮기고, 문서 저장소 이슈도 함께 다뤘습니다.
...
다시 쓰는 작업입니다. 특히 SDK 구현 가이드는 용어 하나만 잘못 옮겨도 의미가 크게 달라질 수 있습니다.

사이드바 개선이나 로컬 Jekyll 빌드 이슈 같은 운영 문제도 번역 과정에서 함께 다루었습니다.
번역뿐만 아니라 문서 저장소를 실제로 유지하는 과정까지 경험한 셈입니다.

## 배운 점

- 좋은 기술 번역은 언어 실력보다 도메인 이해도가 더 중요합니다.
- 문서 저장소도 결국 하나의 제품이며, 빌드와 구조 이슈를 같이 봐야 합니다.
- 오픈소스 문서 기여는 코드 기여와 다른 방식의 정밀함을 요구합니다.
