...
복잡한 메신저를 만들려던 프로젝트가 아니라, LLM을 적용한 대화형 UX를 모바일 앱에서 직접 체험해 보려는 프로젝트였습니다. 당시 목표는 다음과 같았습니다.

- Android 클라이언트에 자연어 응답형 AI를 연동해 보는 것
- 대화 상대의 성격을 하나의 콘셉트로 고정해 UX를 만들어 보는 것
- 별도의 서버 없이도 동작하는 최소 제품을 구성해 보는 것
...
보안을 고려한 장기 운영 구조라기보다, LLM의 응답 흐름을 가장 단순한 경로로 확인하려는 프로토타입 차원의 선택이었습니다.
...
- 서버 없이도 개념 검증은 빠르게 할 수 있지만, 실제로 서비스를 운영하는 단계에서는 보안과 중계 계층이 반드시 필요합니다.
